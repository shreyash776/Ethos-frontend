...
import { googleLoginUser, signIn } from "../../redux/auth/authApi";
...
const SignIn = () => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      dispatch(googleLoginUser(token));
    } catch (err) {
      dispatch(signIn.rejected(err.message));
      dispatch(googleLoginUser.rejected(err.message));
    }
  }
